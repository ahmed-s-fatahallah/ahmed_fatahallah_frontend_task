...
const buttonStylesMapper: ButtonStylesMapper = {
  login:
    "mb-[62px] w-[445px] py-4 bg-dark-gray-2 text-white rounded-[10px] block mx-auto max-md:w-[250px] max-sm:w-[200px] disabled:bg-dark-gray-5 hover:bg-dark-gray font-bold",
